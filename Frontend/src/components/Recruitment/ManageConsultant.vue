                  ...
                  Add Consultant
                            ...
                            <div>
                                <p class="text-red-500 text-start py-2">
                                    **inactive consultant will not be listed
                                    when appliying for the job and will not
                                    searchable by Employer/IT Recruiter
                                </p>
                            </div>
                                ...
                                <table class="w-full max-w-[700px] bg-white">
                                    ...
                                    >
                                        <tr>
                                            ...
                                            <td
                                                class="border border-gray-300 w-[240px]"
                                            >
                                                <div class="flex">
                                                    <div
                                                ...
                                                <div v-if="showSuccessModal" class="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-75">
                                                <div class="bg-white p-8 rounded-lg shadow-lg">
                                                    <h2 class="text-2xl font-bold mb-4">Are you sure you want to delete this consultant?</h2>
                                                    <div
                                                    ...
                                                    <button @click="deleteConsultant(person.id)" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Ok</button>
                                                    <button @click="showSuccessModal = false" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded ml-4">Cancel</button>
                                                </div>
                                                </div>
...
export default {
    ...
    setup() {
        ...
        const fetchConsultants = async () => {
            ...
            console.log(
                response.data.consultant_details,
