<template>
    <div>
        ...
        <div class="bg-[linear-gradient(180deg,#f5f4fa,rgba(251,251,253,0))]">
            ...
            <div
                class="rounded-2xl p-4 sm:p-7 top-[10px] m-auto max-w-[1080px] w-full bg-[#d3ddff4f] sm:mt-6 shadow-[0px_0px_14px_0px_rgba(255,255,255,1);] transition-[.5s]"
            >
                <div
                  ...
                  {{ job.job_title }}
                                ...
                                <div class="flex gap-[10px]">
                                    ...
                                    >
                                        ...
                                        <div
                                            class="flex items-center bg-[#fff] py-1 px-2 mt-2"
                                        >
                                            <span
                                                class="text-[#474d6a] font-bold mr-2 flex gap-2 items-center text-[14px]"
                                            >
        ...
        >
            <div
                class="absolute right-[41%] top-[34.5%]"
                @click="closeOtpModel"
            >
                <svg
                    version="1.0"
