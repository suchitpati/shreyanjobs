<template>
  <div>
    ...
    <div class="bg-[linear-gradient(180deg,#f5f4fa,rgba(251,251,253,0))]">
      <div class="max-w-[1080px] px-[20px] py-[10px] m-auto pb-5">
        <span class="font-[600] text-[17px]"
        ...
        <div class="flex gap-4 mt-2 justify-center items-center">
          <div class="flex gap-1 items-center relative">
            ...
            <input
              type="text"
              v-model="subscribe_skill"
              class="border border-[#000] rounded-md min-h-[25px]"
            />
            <div  v-if=subscribe_skillError class="text-red-600 block text-[14px] text-left absolute top-[29px] left-[50px]">
          ...
          <div class="flex gap-1 items-center relative">
            ...
            <input
              ...
              class="border border-[#000] rounded-md min-h-[25px]"
            />
            <div  v-if=subscribe_emailError class="text-red-600 block text-[14px] text-left absolute top-[29px] left-[60px]">
          ...
          <div>
            <button
              class="bg-[#FFDAB9] text-[#000] text-[14px] px-3 py-1 rounded-md"
              @click="openOtpModel"
            >
              Subscribe
            </button>
            ...
            <div v-if="jobs.length">
              ...
              >
                ...
                <div class="flex gap-2 w-full mt-2 flex-wrap">
                  ...
                  <div class="flex items-center bg-[#fff] py-1 px-2">
                    <span
                      class="text-[#474d6a] font-bold mr-2 flex gap-2 items-center text-[14px]"
                    >
                      <svg
