        ...
        <div class="bg-[#ebf4ff] py-0  ">
            <div class="max-w-[980px] w-full mx-auto px-[20px]">
                ...
                <span
                    ...
                    >Your job was posted successfully and can be viewed in the
                    home page.</span
                >
                <div
                ...
                >
                    <div class="mt-4">
                        ...
                        >
                            <div class="sm:w-[100%] mb-4">
                                <label
                                    ...
                                    for="field2"
                                >
                                    If this job has multiple locations or you
                                    want to specify hybrid/ Day 1 onsite work
                                    model, use “Additional Job Position Detail”
                                    section below
                                </label>
                            </div>
                        </div>
                        ...
                        >
                            <legend class="text-left ml-4 pl-1 pr-1">
                                Location :
                            </legend>
                            <div
                    ...
                    <div>
                        ...
                        <div class="text-end">
                            <span class="text-blue-700 text-[16px]"
                                >Characters left:
                                {{ remaining_additional_detail }}/500</span
                            >
                        </div>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div class="text-end">
                            <span class="text-blue-700 text-[16px]"
                                >Characters left:
                                {{ remaining_technical_skill }}/2000</span
                            >
                        </div>
                    </div>
                    <button
...
export default {
    ...
    setup() {
        ...
        onMounted(() => {
            ...
            addJobMessageStatus.value = localStorage.getItem(
                "addJobMessageStatus"
            );
